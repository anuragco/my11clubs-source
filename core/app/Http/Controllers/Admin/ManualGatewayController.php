...
{
    $gatewayCurrency = GatewayCurrency::all();
    $plan = Plan::find($id); // Assuming you have a plan ID to pass

    // Add $general variable
    $general = GeneralSetting::first();

    return view('templates.ptc_diamond.user.payment.deposit', compact('gatewayCurrency', 'plan', 'general'));
}
