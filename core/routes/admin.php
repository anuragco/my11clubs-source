...
use App\Http\Controller\admin\ManageUsersController;
...
Route::middleware('admin')->group(function () {
    ...
    Route::get('export-pdf', [UserDetailsController::class, 'exportPdf'])->name('export-pdf');
        ...
        // Route::get('/salary', function () {   return view('admin.salary'); })->name('admin.salary.index');
        // // routes/admin.php


//      Route::get('/user-details', function () {
//     // Fetch users and pass them to the view
//     $users = App\Models\User::all(); // Adjust this query to fetch users as per your application logic
...
// })->name('admin.user.details');
      ...
      Route::prefix('salary')->name('salary.')->group(function () {
        ...
        Route::get('/salary', function () {   return view('admin.salary'); })->name('admin.salary.index');
        // Other salary routes can be added here as needed
        //  Route::get('/fx', function () {
        //     return view('admin.fxsalery');
        // })->name('admin.fxsalery');
    });
            
           // In routes/admin.php or routes/web.php
Route::get('/admin/userdetails', [App\Http\Controllers\Admin\UserDetailsController::class, 'index'])->name('admin.userdetails');

            Route::prefix('users')->name('users.')->group(function () {
            Route::post('/{id}/update-salary', [App\Http\Controllers\Admin\ManageUsersController::class, 'updateSalary'])->name('update.salary');
            });
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::post('/users/{id}/update-salary', [App\Http\Controllers\Admin\ManageUsersController::class, 'updateSalary'])->name('admin.users.update.salary');
    ...
    Route::post('/plan/status/{id}', 'PlanController@status')->name('plan.status');
    ...
    //PTC Reports
    Route::controller('PtcReportController')->name('ptcreport.')->prefix('ptcreport')->group(function () {
        Route::get('type', 'reportType')->name('type');
        Route::post('type', 'reportTypeSave')->name('type.save');
        Route::post('type/status/{id}', 'reportTypeStatus')->name('type.status');
        Route::get('logs', 'reportLogs')->name('logs');
        // Route::get('/userdetails', [UserDetailsController::class, 'index'])->name('admin.userdetails');
    });
