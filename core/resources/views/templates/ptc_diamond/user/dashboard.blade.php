...
@section('content')
    ...
    <div class="row g-4 g-lg-3 g-xxl-4">
        ...
        <div>
            <p class='useerwel'>Welcome <strong class='namewel'>{{ $user->fullname ?? $user->lastname }}</strong></p>
        </div>
            ...
            <div class="widget-container">
                ...
                <div class="dashboard-widget">
                    ...
                    <div class="dashboard-widget__content">
                        <h4 class="dashboard-widget__amount timer" id="counterr">
                             {{ $totalEarnings }} {{ __(gs('cur_text')) }}
                        </h4>
                    </div>
       ...
       <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="widget-container">
                ...
                <div class="dashboard-widget">
                    ...
                    <div class="dashboard-widget__content">
                        <h4 class="dashboard-widget__amount timer" id="counterr">
                             {{ __($totaladsincome) }} {{ __(gs('cur_text')) }}
                        </h4>
                    </div>
                    <span class="dashboard-widget__overlay-icon">
                        <i class="fas fa-clock"></i>
        ...
        <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="widget-container">
                ...
                <div class="dashboard-widget">
                    ...
                    <h4 class="dashboard-widget__amount Directjsdfjsh">
                        {{ $commissionCount ?? '0' }} {{ __(gs('cur_text')) }}
                    </h4>
                    <span class="dashboard-widget__overlay-icon">
                        <i class="fas fa-clock"></i>
                    </span>
        ...
        <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="widget-container">
                ...
                <div class="dashboard-widget">
                    ...
                    <div class="dashboard-widget__content">
                        <h4 class="dashboard-widget__amount">
                            {{ $commissionCountExcludeLevel1 ?? '0' }} {{ __(gs('cur_text')) }}
                        </h4>
                    </div>
                    <span class="dashboard-widget__overlay-icon">
                        <i class="fas fa-clock"></i>
        ...
        <!--        <div class="widget-container__head">-->
        <!--            <span class="dashboard-widget__title">-->
        <!--                @lang('LifeTime Income (Direct + Level + Salary)')-->
        <!--            </span>-->
        <!--        </div>-->
        <!--        <div class="dashboard-widget">-->
        <!--            <div class="dashboard-widget__icon">-->
        ...
        <!--            <div class="dashboard-widget__content">-->
        <!--                <h4 class="dashboard-widget__amount timer" id="counterr">-->
        <!--                     {{ __($totalEarnings) }} {{ __(gs('cur_text')) }}-->
        <!--                </h4>-->
        <!--            </div>-->
        <!--            <span class="dashboard-widget__overlay-icon">-->
        <!--                <i class="fas fa-clock"></i>-->
