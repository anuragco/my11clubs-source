                    ...
                    <div class="payment-system-list is-scrollable gateway-option-list">
                        ...
                        @if ($plan)
                            <label for="account_balance" class="payment-item gateway-option">
                                ...
                                <input class="payment-item__radio gateway-input" id="account_balance" hidden type="radio" name="gateway" value="wallet"
                        ...
                        @foreach ($gatewayCurrency as $data)
                           ...
                           <!--<label for="instant_deposit" class="payment-item gateway-option">-->
                           <!--     <div class="payment-item__info">-->
                           <!--         <span class="payment-item__check"></span>-->
                           <!--         <span class="payment-item__name">@lang('Instant Deposit')</span>-->
                           <!--     </div>-->
                           <!--     <div class="payment-item__thumb">-->
                           <!--         <img class="payment-item__thumb-img" src="{{ getImage(getFilePath('gateway') . '/' . $data->method->image) }}" alt="@lang('payment-thumb')">-->
                           <!--     </div>-->
                           <!--     <input class="payment-item__radio gateway-input" id="instant_deposit" hidden type="radio" name="gateway" value="instant_deposit">-->
                           <!-- </label>-->
                ...
                <div class="col-lg-6">
                    <div class="payment-system-list p-3">
                            ...
                            <div class="deposit-info__input">
                                <div class="deposit-info__input-group input-group">
                                    ...
                                    <input type="text" class="form-control form--control amount" name="amount" placeholder="@lang('00.00')"
                                        value="{{ $amount }}" @if (@$plan) readonly @endif autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="d-none hideInfo crypto-message mb-3">
                            @lang('Conversion with') <span class="gateway-currency"></span> @lang('and final value will Show
                                                    on next step')
                        </div>
                        ...
                        <div class="info-text pt-3">
                            <p class="text">@lang('Ensuring your funds grow safely through our secure deposit process with
                                                        world-class payment options.')</p>
                        </div>
                    </div>
                </div>
            </div>
