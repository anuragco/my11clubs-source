                ...
                <div class="nav-container">
                    <ul class="list primary-menu  justify-content-lg-end">
                        ...
                        @foreach ($pages as $page)
                            @if ($page->slug != 'home' && $page->slug != 'Gallary' && $page->slug != 'contact')
                                <li>
                        ...
                        @endforeach
                        <li>
                            <a href="{{ route('plans') }}" class="primary-menu__link">@lang('subscriptions ')</a>
                        </li>
                        <li>
                            <a href="https://ln.run/psTzq" target="_blank" class="primary-menu__link">@lang('Business Plan')</a>
                        </li>
                        <li>
                            <a href="{{ route('blog') }}" class="primary-menu__link">@lang('Gallery')</a>
                        </li>
                        <li class="nav-item">
