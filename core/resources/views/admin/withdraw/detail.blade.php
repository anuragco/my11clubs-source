                    ...
                    @if($withdrawal->status == Status::PAYMENT_PENDING)
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-outline--warning btn-sm ms-1" data-bs-toggle="modal" data-bs-target="#rejectModal">
                                    <i class="fa-solid fa-circle-check"></i> @lang('Verify Bank Account')
                                </button>
                            </div>
                        </div>
                    @endif
