jQuery(document).ready(function ($) {
    ...
    document.querySelector('.social-whatsapp').addEventListener('click', function() {
        // Get the WhatsApp URL from the input field
        var whatsappUrl = document.getElementById('niteoCS_whatsapp').value;
